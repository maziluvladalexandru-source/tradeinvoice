...
const moreItems = [
  { href: "/time-tracking", labelKey: "timeTracking" as const, icon: "⏱️" },
  { href: "/reports", labelKey: "reports" as const, icon: "📊" },
  { href: "/services", labelKey: "services" as const, icon: "🔧" },
