...
function VATCalculator() {
  ...
  return (
    <div className="bg-[#111827] border border-gray-700/50 rounded-2xl p-6 sm:p-8 hover:border-amber-500/30 transition-all duration-200 card-hover">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 text-xl">%</div>
        <div>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
              i === countryIdx
                ...
                : "bg-[#0a0f1e] border border-gray-700/50 text-gray-400 hover:border-white/20"
            }`}
          >
            {c.flag}
            <span>{c.code}</span>
      ...
      <button
        ...
        className="mb-4 text-sm px-4 py-2 rounded-lg bg-[#0a0f1e] border border-gray-700/50 text-gray-300 hover:border-amber-500/30 transition-colors"
      >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-[#0a0f1e] border border-gray-700/50 rounded-xl pl-10 pr-4 py-3 text-white text-lg placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-200"
        />
      </div>

      {/* Results */}
      {result && (
        <div className="space-y-3 bg-[#0a0f1e]/50 border border-gray-700/30 rounded-xl p-5">
...
function InvoiceNumberGenerator() {
  ...
  return (
    <div className="bg-[#111827] border border-gray-700/50 rounded-2xl p-6 sm:p-8 hover:border-amber-500/30 transition-all duration-200 card-hover">
      ...
      {/* Generated number */}
      <div className="bg-[#0a0f1e]/50 border border-gray-700/30 rounded-xl p-5 flex items-center justify-between mb-5">
        <span className="text-2xl font-mono font-bold text-white">{number}</span>
        <div className="flex gap-2">
          <button
            onClick={() => regenerate()}
            className="p-2 rounded-lg bg-[#0a0f1e] border border-gray-700/50 text-gray-400 hover:text-white hover:border-white/20 transition-all"
            title="Generate new"
          >
    ...
    <div className="bg-[#111827] border border-gray-700/50 rounded-2xl p-6 sm:p-8 hover:border-amber-500/30 transition-all duration-200 card-hover">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full bg-[#0a0f1e] border border-gray-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-200 [color-scheme:dark]"
        />
      </div>
      ...
      {/* Result */}
      {result && (
        <div className="bg-[#0a0f1e]/50 border border-gray-700/30 rounded-xl p-5 space-y-3">
          <div className="flex justify-between">
...
export default function ToolsPage() {
  return (
    <div className="min-h-screen bg-[#0a0f1e]">
      {/* Nav */}
      <nav className="border-b border-gray-700/50 bg-[#0a0f1e]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="text-xl font-bold text-amber-400 tracking-tight">
            TradeInvoice
          </Link>
          <div className="flex items-center gap-6">
            <Link href="/blog" className="text-gray-400 hover:text-white text-sm transition-all duration-200">Blog</Link>
            <Link href="/templates" className="text-gray-400 hover:text-white text-sm transition-all duration-200">Templates</Link>
            <Link
              href="/auth/login"
              className="bg-gradient-to-r from-amber-500 to-amber-400 text-gray-950 px-4 py-2 rounded-xl font-semibold text-sm hover:from-amber-400 hover:to-amber-300 transition-all duration-200 shadow-lg shadow-amber-500/20"
            >
              Sign In
            </Link>
          </div>
      ...
      <footer className="bg-[#0a0f1a] border-t border-gray-700/50 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-700/30 text-center text-gray-600 text-sm">
