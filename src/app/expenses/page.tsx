  ...
  return (
    <div className="min-h-screen bg-gray-950 pb-20 md:pb-0">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Tab Toggle */}
        <div className="flex gap-1 bg-gray-900/50 rounded-xl p-1 border border-gray-800/50 mb-8 w-fit">
          <button
        ...
        {activeTab === "expenses" ? (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="relative overflow-hidden bg-gray-900/50 backdrop-blur-sm rounded-2xl p-5 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-300 col-span-1 sm:col-span-2 lg:col-span-1">
              ...
              {categoryBreakdown.slice(0, 3).map((cat) => (
                <div key={cat.value} className="relative overflow-hidden bg-gray-900/50 backdrop-blur-sm rounded-2xl p-5 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-300">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-800/50 border border-gray-700/50 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-amber-500/50"
                      />
                    </div>
                  </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-2 text-sm">
                            ...
                            {expense.taxDeductible && (
                              <span className="text-emerald-500 text-xs">Tax deductible</span>
                            )}
                          </div>
                          {expense.notes && (
          ...
          <>
            {userPlan !== "pro" ? (
              ...
              <>
                ...
                {/* Tax Info Note */}
                <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-4 mb-8 flex items-start gap-3">
                  ...
                  <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800/50 p-6 mb-8">
                    ...
                    <form onSubmit={handleMileageSubmit} className="space-y-4">
                      ...
                      {mileageForm.distance && (
                        <div className="bg-gray-800/30 rounded-xl px-4 py-3 text-sm">
                          ...
                          <div className="flex items-start gap-3">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex flex-wrap items-center gap-2 text-sm">
                                ...
                                {entry.billable && (
                                  <span className="text-amber-500 text-xs">Billable</span>
                                )}
                              </div>
                            </div>
                            <div className="text-right shrink-0">
